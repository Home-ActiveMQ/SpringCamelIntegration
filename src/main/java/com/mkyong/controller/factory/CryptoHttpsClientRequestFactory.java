package com.mkyong.controller.factory;
...
public class CryptoHttpsClientRequestFactory extends SimpleClientHttpRequestFactory {

    private Logger logger = LogManager.getLogger(CryptoHttpsClientRequestFactory.class);
